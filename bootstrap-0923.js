...
// Reconstruct the known-good v0.9.22 compact base before applying the v0.9.23 UI patch.
...
console.log('Verified v0.9.22 base payload:',b64.length,'chars / HTML:',html.length,'bytes');
require('./server-0923.js');
