...
if(Buffer.byteLength(html)!==276813)throw new Error('Unexpected v0.9.27 HTML length: '+Buffer.byteLength(html));
if(sha(html)!=='33c05e69ff1b51ed45529886992c15bf255c40cb780d986e0eb38679d19e5325')throw new Error('v0.9.27 HTML SHA mismatch');
...
source=source.replace("version:'0.9.23'","version:'0.9.27'");
source=source.replace('JEWEL de PON v0.9.23 server:','JEWEL de PON v0.9.27 server:');
const runtimeFile=path.join(ROOT,'server-0927-runtime.js');
