...
source=source.replace("version:'0.9.23'","version:'0.9.38'");
source=source.replace('JEWEL de PON v0.9.23 server:','JEWEL de PON v0.9.38 server:');
...
const runtimeFile=path.join(ROOT,'server-0938-runtime.js');
