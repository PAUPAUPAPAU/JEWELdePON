...
if(Buffer.byteLength(html)!==276718)throw new Error('Unexpected v0.9.26 HTML length: '+Buffer.byteLength(html));
if(sha(html)!=='0570d5b55e75bcbc016aff5d532e1d714aa5c0619ce6462a385417051dc51692')throw new Error('v0.9.26 HTML SHA mismatch');
...
source=source.replace("version:'0.9.23'","version:'0.9.26'");
source=source.replace('JEWEL de PON v0.9.23 server:','JEWEL de PON v0.9.26 server:');
const runtimeFile=path.join(ROOT,'server-0926-runtime.js');
