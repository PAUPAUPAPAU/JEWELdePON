...
source=source.replace("version:'0.9.23'","version:'0.9.31'");
source=source.replace('JEWEL de PON v0.9.23 server:','JEWEL de PON v0.9.31 server:');
...
const runtimeFile=path.join(ROOT,'server-0931-runtime.js');
