...
source=source.replace("version:'0.9.23'","version:'0.9.37'");
source=source.replace('JEWEL de PON v0.9.23 server:','JEWEL de PON v0.9.37 server:');
...
const runtimeFile=path.join(ROOT,'server-0937-runtime.js');
