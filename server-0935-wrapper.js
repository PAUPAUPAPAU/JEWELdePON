...
source=source.replace("version:'0.9.23'","version:'0.9.35'");
source=source.replace('JEWEL de PON v0.9.23 server:','JEWEL de PON v0.9.35 server:');
...
const runtimeFile=path.join(ROOT,'server-0935-runtime.js');
