...
if(Buffer.byteLength(html)!==275038)throw new Error('Unexpected v0.9.25 HTML length: '+Buffer.byteLength(html));
if(sha(html)!=='cb32234536843185eea38e3eafa657613291b961dacacea44dc2f89d73ddea5e')throw new Error('v0.9.25 HTML SHA mismatch');
...
source=source.replace("version:'0.9.23'","version:'0.9.25'");
source=source.replace('JEWEL de PON v0.9.23 server:','JEWEL de PON v0.9.25 server:');
const runtimeFile=path.join(ROOT,'server-0925-runtime.js');
